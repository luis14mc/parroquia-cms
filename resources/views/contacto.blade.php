<x-layouts.app title="Contacto | Parroquia Cristo Resucitado" description="Visítenos en nuestra parroquia o póngase en contacto con nosotros a través de nuestros canales digitales.">
    ...
    <section class="relative w-full h-[340px] sm:h-[400px] flex items-center justify-center overflow-hidden">
        <div class="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('images/heroes/hero_contacto.jpg') }}');">
    ...
    {{-- ═══════════════════════════════════════════════════════
         2. TARJETAS DE CONTACTO RÁPIDO (QUICK INFO)
    ═══════════════════════════════════════════════════════ --}}
        ...
        <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <a href="https://wa.me/{{ $whatsapp }}?text=Hola%2C%20necesito%20informaci%C3%B3n." target="_blank" rel="noopener noreferrer"
                   class="group bg-white dark:bg-[#211c11] rounded-xl p-5 shadow-lg border border-gray-100 dark:border-gray-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-center">
                    <div class="w-12 h-12 mx-auto mb-3 rounded-full bg-green-500/10 flex items-center justify-center group-hover:bg-green-500 transition-colors">
                        <svg class="w-6 h-6 text-green-500 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                ...
                {{-- Ubicación --}}
                <div class="group bg-white dark:bg-[#211c11] rounded-xl p-5 shadow-lg border border-gray-100 dark:border-gray-800 text-center">
                    <div class="w-12 h-12 mx-auto mb-3 rounded-full bg-secondary/10 flex items-center justify-center text-secondary">
                        <span class="material-symbols-outlined text-secondary transition-colors">location_on</span>
                    </div>
                ...
                {{-- Horario --}}
                <div class="group bg-white dark:bg-[#211c11] rounded-xl p-5 shadow-lg border border-gray-100 dark:border-gray-800 text-center">
                    <div class="w-12 h-12 mx-auto mb-3 rounded-full bg-primary/10 flex items-center justify-center text-primary">
                        <span class="material-symbols-outlined text-primary transition-colors">schedule</span>
                    </div>
        ...
        <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-10">
                        ...
                        <form x-data="{ nombre: '', email: '', asunto: '', mensaje: '' }" 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input type="text" id="nombre_completo" x-model="nombre" placeholder="Juan Pérez" required class="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800 text-text-dark dark:text-white focus:border-primary focus:ring-1 focus:ring-primary h-12 px-4 outline-none transition-colors" />
                                </div>
                                <div>
                                    ...
                                    <input type="email" id="email" x-model="email" placeholder="juan@ejemplo.com" required class="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800 text-text-dark dark:text-white focus:border-primary focus:ring-1 focus:ring-primary h-12 px-4 outline-none transition-colors" />
                                </div>
                            </div>
                            <div>
                                ...
                                <input type="text" id="asunto" x-model="asunto" placeholder="Motivo de su mensaje" required class="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800 text-text-dark dark:text-white focus:border-primary focus:ring-1 focus:ring-primary h-12 px-4 outline-none transition-colors" />
                            </div>
                            <div>
                                ...
                                <textarea id="mensaje" x-model="mensaje" placeholder="Escriba su mensaje aquí..." required class="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800 text-text-dark dark:text-white focus:border-primary focus:ring-1 focus:ring-primary min-h-[150px] p-4 resize-y outline-none transition-colors"></textarea>
                            </div>
                ...
                <div class="lg:col-span-2 flex flex-col gap-6">
                    ...
                    {{-- Horario de Oficina --}}
                    <div class="bg-white dark:bg-[#211c11] rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-800">
                    ...
                    {{-- Datos de Contacto --}}
                    <div class="bg-white dark:bg-[#211c11] rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-800 space-y-5">
                    ...
                    <div class="bg-white dark:bg-[#211c11] rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-800">
                        ...
                        <div class="flex gap-3">
                            <a href="https://www.facebook.com/cristoresucitadohn/" target="_blank" class="h-11 w-11 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 hover:bg-[#1877F2] hover:text-white transition-all duration-300">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
                            </a>
                            <a href="https://www.instagram.com/cristoresucitadohn" target="_blank" class="h-11 w-11 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 hover:bg-gradient-to-br hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#bc1888] hover:text-white transition-all duration-300">
                            ...
                            <a href="https://www.youtube.com/channel/UCDZi5Fc70E2pPzze72SSpcw" target="_blank" class="h-11 w-11 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 hover:bg-[#FF0000] hover:text-white transition-all duration-300">
                            ...
                            <a href="https://x.com/cristo_hn" target="_blank" class="h-11 w-11 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 hover:bg-black hover:text-white transition-all duration-300">
                            ...
                            <a href="https://www.tiktok.com/@cristoresucitadohn" target="_blank" class="h-11 w-11 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 hover:bg-black hover:text-white transition-all duration-300">
        ...
        <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="order-2 lg:order-1">
                    <div class="w-full h-[400px] rounded-3xl overflow-hidden shadow-2xl border border-gray-100 dark:border-zinc-700 relative group">
                        <div id="map" class="w-full h-full z-0"></div>
                        {{-- Branded Overlay --}}
                        <div class="absolute top-4 right-4 z-10 bg-white/90 dark:bg-[#211c11]/90 backdrop-blur px-4 py-2 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800">
                            <p class="text-[10px] font-bold uppercase tracking-widest text-primary">Sede Parroquial</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="order-1 lg:order-2 space-y-8">
                    <div>
                        <span class="inline-block px-4 py-1.5 mb-4 text-[10px] font-bold tracking-widest text-primary uppercase bg-primary/10 rounded-full">Ubicación</span>
                        <h2 class="text-3xl sm:text-4xl font-black text-text-dark dark:text-white leading-tight">
                            ¿Cómo llegar?
                        </h2>
                        <p class="text-gray-500 dark:text-gray-400 mt-4 leading-relaxed">
                            Nuestra sede parroquial se encuentra en la <b>Colonia Loarque</b>, sobre la calle principal. Puede visitarnos fácilmente utilizando su aplicación de navegación preferida.
                        </p>
                    </div>

                    <div class="flex flex-col sm:flex-row gap-4">
                        {{-- Google Maps --}}
                        <a href="https://maps.app.goo.gl/c1SuVCoCHav1yNZ46" target="_blank" rel="noopener" 
                           class="flex items-center justify-center gap-3 px-8 py-4 bg-white dark:bg-zinc-800 text-text-dark dark:text-white font-bold rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 transition-all border border-gray-100 dark:border-zinc-700 group">
                        ...
                        {{-- Waze --}}
                        <a href="https://waze.com/ul?ll=14.0329,-87.2165&navigate=yes" target="_blank" rel="noopener" 
                           class="flex items-center justify-center gap-3 px-8 py-4 bg-[#33ccff] text-white font-bold rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 transition-all group">
                            <svg class="w-7 h-7 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M12.002 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75-4.365-9.75-9.75-9.75zm4.5 13.5c-.828 0-1.5-.672-1.5-1.5s.672-1.5 1.5-1.5 1.5.672 1.5 1.5-.672 1.5-1.5 1.5zm-9 0c-.828 0-1.5-.672-1.5-1.5s.672-1.5 1.5-1.5 1.5.672 1.5 1.5-.672 1.5-1.5 1.5zm1.5-6.75c-.828 0-1.5-.672-1.5-1.5s.672-1.5 1.5-1.5 1.5.672 1.5 1.5-.672 1.5-1.5 1.5zm6 0c-.828 0-1.5-.672-1.5-1.5s.672-1.5 1.5-1.5 1.5.672 1.5 1.5-.672 1.5-1.5 1.5z"/>
                            </svg>
                            <span>Waze</span>
                        </a>
                    </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                    ...
                    html: `
                        <div class="relative flex items-center justify-center">
                            ...
                            <div class="relative w-10 h-10 bg-primary rounded-full border-4 border-white shadow-lg flex items-center justify-center">
                                <span class="material-symbols-outlined text-white text-xl">church</span>
                            </div>
                        </div>
                    `,
                    className: '',
                ...
                L.marker([lat, lng], { icon: customIcon }).addTo(map)
                    .bindPopup('<b class="text-primary">Parroquia Cristo Resucitado</b><br>Colonia Loarque')
                    .openPopup();
            });
        </script>
    @endpush
