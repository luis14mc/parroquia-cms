    ...
    <section class="relative z-10 -mt-16 pb-12">
        <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {{-- WhatsApp --}}
                <a href="https://wa.me/50494306883?text=Hola%2C%20necesito%20informaci%C3%B3n." target="_blank" rel="noopener noreferrer"
                   class="group bg-white dark:bg-zinc-800 rounded-xl p-5 shadow-lg border border-gray-100 dark:border-zinc-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-center">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">+504 9430-6883</p>
                </a>
                ...
                <a href="https://maps.app.goo.gl/YourMapLink" target="_blank" rel="noopener noreferrer"
                   class="group bg-white dark:bg-zinc-800 rounded-xl p-5 shadow-lg border border-gray-100 dark:border-zinc-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-center">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Col. Loarque, Tegucigalpa</p>
                </a>
                ...
                <div class="group bg-white dark:bg-zinc-800 rounded-xl p-5 shadow-lg border border-gray-100 dark:border-zinc-700 text-center">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Lun-Vie 8AM-5PM</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="lg:col-span-3">
                    <div class="bg-white dark:bg-zinc-800 rounded-2xl p-8 shadow-sm border border-gray-100 dark:border-zinc-700">
                        ...
                        <form action="{{ route('contacto.store') }}" method="POST" class="space-y-5">
                            ...
                            {{-- Mensaje de éxito --}}
                            @if(session('success'))
                                <div class="flex items-center gap-3 p-4 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-300 text-sm">
                            ...
                            @if($errors->any())
                                <div class="flex items-start gap-3 p-4 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 text-sm">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input type="text" id="nombre_completo" name="nombre_completo" value="{{ old('nombre_completo') }}" placeholder="Juan Pérez" required class="w-full rounded-lg border border-gray-200 dark:border-zinc-600 bg-gray-50 dark:bg-zinc-900 text-text-dark dark:text-white focus:border-primary focus:ring-1 focus:ring-primary h-12 px-4 outline-none transition-colors" />
                                ...
                                <div>
                                    ...
                                    <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="juan@ejemplo.com" required class="w-full rounded-lg border border-gray-200 dark:border-zinc-600 bg-gray-50 dark:bg-zinc-900 text-text-dark dark:text-white focus:border-primary focus:ring-1 focus:ring-primary h-12 px-4 outline-none transition-colors" />
                            ...
                            <div>
                                ...
                                <textarea id="mensaje" name="mensaje" placeholder="Escriba su mensaje aquí..." required class="w-full rounded-lg border border-gray-200 dark:border-zinc-600 bg-gray-50 dark:bg-zinc-900 text-text-dark dark:text-white focus:border-primary focus:ring-1 focus:ring-primary min-h-[150px] p-4 resize-y outline-none transition-colors">{{ old('mensaje') }}</textarea>
                                @error('mensaje') <p class="text-xs text-red-500 mt-1">{{ $message }}</p> @enderror
                            </div>
                            <button type="submit" class="inline-flex items-center gap-2 px-8 py-3 bg-primary hover:bg-primary/90 text-white font-bold rounded-lg transition-all shadow-md hover:shadow-lg">
                ...
                <div class="lg:col-span-2 flex flex-col gap-6">
                    ...
                    <div class="bg-white dark:bg-zinc-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-zinc-700">
                        ...
                        <ul class="space-y-3 text-sm">
                            <li class="flex justify-between text-gray-600 dark:text-gray-400 border-b border-dashed border-gray-200 dark:border-zinc-700 pb-2">
                                ...
                                <span class="font-semibold text-text-dark dark:text-white">8:00 AM - 5:00 PM</span>
                            </li>
                            <li class="flex justify-between text-gray-600 dark:text-gray-400 border-b border-dashed border-gray-200 dark:border-zinc-700 pb-2">
                                <span>Sábados</span>
                                <span class="font-semibold text-text-dark dark:text-white">9:00 AM - 12:00 PM</span>
                            </li>
                            <li class="flex justify-between text-gray-600 dark:text-gray-400">
                                <span>Domingos</span>
                                <span class="font-semibold text-text-dark dark:text-white">Cerrado</span>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="flex gap-4 items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 dark:text-gray-400 text-sm mt-1 leading-relaxed">
                                    Colonia Loarque, Salida al Sur<br />Tegucigalpa, Honduras
                                </p>
                            </div>
                        </div>
                        <div class="flex gap-4 items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">
                                    <a class="hover:text-primary transition-colors" href="tel:+50494306883">+504 9430-6883</a>
                                </p>
                            </div>
                        </div>
                        <div class="flex gap-4 items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">
                                    <a class="hover:text-primary transition-colors" href="mailto:info@cristoresucitado.hn">info@cristoresucitado.hn</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-zinc-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-zinc-700">
                        ...
                        <div class="flex gap-3">
                            <a href="#" class="h-11 w-11 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-zinc-700 text-gray-500 dark:text-gray-400 hover:bg-[#1877F2] hover:text-white transition-all duration-300">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
                            </a>
                            <a href="#" class="h-11 w-11 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-zinc-700 text-gray-500 dark:text-gray-400 hover:bg-gradient-to-br hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#bc1888] hover:text-white transition-all duration-300">
                            ...
                            <a href="https://wa.me/50494306883" target="_blank" rel="noopener noreferrer" class="h-11 w-11 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-zinc-700 text-gray-500 dark:text-gray-400 hover:bg-[#25D366] hover:text-white transition-all duration-300">
    ...
    <section class="py-12 bg-white dark:bg-zinc-900">
        <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 dark:text-gray-400 text-sm mt-2">Colonia Loarque, Salida al Sur — Tegucigalpa, Honduras</p>
            </div>
            <div class="w-full h-80 rounded-2xl overflow-hidden shadow-lg border border-gray-200 dark:border-zinc-700">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3870.5!2d-87.24!3d14.05!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTTCsDAzJzAwLjAiTiA4N8KwMTQnMjQuMCJX!5e0!3m2!1ses!2shn!4v1"
