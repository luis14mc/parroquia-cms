<x-layouts.app title="Contacto | Parroquia Cristo Resucitado" description="Visítenos en nuestra parroquia o póngase en contacto con nosotros a través de nuestros canales digitales.">
    ...
    @php
        $horarios = json_decode($contenidos['contacto.horario_oficina'] ?? '{}', true) ?: [];
        $whatsapp = $contenidos['contacto.whatsapp'] ?? ($general['general.whatsapp'] ?? '50494306883');
        $telefono = $contenidos['contacto.telefono'] ?? '+504 9430-6883';
        $email = $contenidos['contacto.email'] ?? 'info@cristoresucitado.hn';
        $direccion = $contenidos['contacto.direccion'] ?? 'Colonia Loarque, Salida al Sur, Tegucigalpa, Honduras';
        $mapaSrc = $contenidos['contacto.mapa_iframe'] ?? 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3870.5!2d-87.24!3d14.05!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTTCsDAzJzAwLjAiTiA4N8KwMTQnMjQuMCJX!5e0!3m2!1ses!2shn!4v1';
    @endphp
                ...
                <div class="lg:col-span-2 flex flex-col gap-6">
                    ...
                    <div class="bg-white dark:bg-zinc-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-zinc-700">
                        ...
                        <div class="flex gap-3">
                            <a href="{{ $contenidos['contacto.facebook'] ?? '#' }}" class="h-11 w-11 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-zinc-700 text-gray-500 dark:text-gray-400 hover:bg-[#1877F2] hover:text-white transition-all duration-300">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
                            </a>
                            <a href="{{ $contenidos['contacto.instagram'] ?? '#' }}" class="h-11 w-11 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-zinc-700 text-gray-500 dark:text-gray-400 hover:bg-gradient-to-br hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#bc1888] hover:text-white transition-all duration-300">
