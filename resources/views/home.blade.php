        ...
        <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-lg mx-auto">
                <div class="bg-white dark:bg-[#211c11] rounded-xl p-8 border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md transition-all group ring-2 ring-primary/15">
                    ...
                    <a href="{{ route('forms.show', ['slug' => 'taller-solidaridad']) }}" class="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-3.5 text-base font-bold text-text-dark bg-primary rounded-lg hover:bg-primary/90 transition-all shadow-lg shadow-primary/25">
                        Ir al formulario
