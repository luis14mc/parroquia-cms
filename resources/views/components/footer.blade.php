        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="flex items-center gap-3">
                    ...
                    {{-- TikTok --}}
                    <a href="#" class="w-10 h-10 rounded-full bg-white/10 hover:bg-primary hover:text-background-dark flex items-center justify-center transition-colors" aria-label="TikTok">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.34-6.34V9.26a8.28 8.28 0 004.76 1.5v-3.4a4.85 4.85 0 01-1-.67z"/></svg>
                    </a>
                    {{-- YouTube --}}
                    ...
                    {{-- X (Twitter) --}}
                    <a href="#" class="w-10 h-10 rounded-full bg-white/10 hover:bg-primary hover:text-background-dark flex items-center justify-center transition-colors" aria-label="X (Twitter)">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-text-muted text-sm">
                            Colonia Loarque, calle principal.<br>
                            Tegucigalpa, Honduras
                        </span>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="material-symbols-outlined text-primary">phone</span>
                        <a href="tel:+50494306883" class="text-text-muted hover:text-primary transition-colors text-sm">
                            9430-6883
                        </a>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="material-symbols-outlined text-primary">mail</span>
                        <a href="mailto:cristohnresucitado@gmail.com" class="text-text-muted hover:text-primary transition-colors text-sm">
                            cristohnresucitado@gmail.com
                        </a>
                    </li>
                    <li class="flex items-start gap-3">
