...
<x-layouts.app title="{{ $title }} | Pastorales | Parroquia Cristo Resucitado" description="{{ Str::limit(strip_tags($introText), 160) }}">
    ...
    <section class="py-24 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 relative z-10 text-center">
            <h2 class="text-3xl sm:text-5xl font-black text-white mb-6 tracking-tight">¿Quieres unirte a esta pastoral?</h2>
            <p class="text-white/90 text-lg sm:text-xl mb-10 leading-relaxed">
                Tu servicio marca la diferencia. Acércate y forma parte de esta misión evangelizadora.
            </p>
